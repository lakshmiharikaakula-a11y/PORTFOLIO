    ...
    <div  id="projects" className="project-container">
        ...
        <div className="project-card">
         ...
         <div className="project-card">
            ...
            <p>Tech Stack: React, CSS, JavaScript</p>
            <div className="buttons">
                <a href="https://github.com/lakshmiharikaakula-a11y/expense-split.git" target="_blank">GitHub</a>
                <a href="https://expense-split-bj31.vercel.app/" target="_blank">Live Demo</a>
            </div>
        </div>
    </div>
  )
